...
اسپلش یک صحنهٔ سینمایی کتابخانه (قفسه‌ها / ماه / گلبرگ) با نقل‌قول وسط صفحه و نوار پیشرفت قطعه‌ای است؛ اتریبیوشن از فیلد `attribution` به شکل `شخصیت · اثر` خوانده می‌شود.
