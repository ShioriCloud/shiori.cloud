...
`#121212` ≈ پس‌زمینه دارک اپ (`bg-background`) تا با اسپلش داخل اپ هم‌خوان باشد.
...
اسپلش یک صحنهٔ سینمایی کتابخانه (قفسه‌ها / ماه / گلبرگ) با نقل‌قول وسط صفحه است. نوار پیشرفت و متن وضعیت به لود واقعی P0 هوم (پیشنهاد ویژه، تازه‌ها، فصل جاری، چیدمان) وصل‌اند؛ حداقل زمان خواندن دیالوگ و سقف زمانی برای نت ضعیف هم دارند. اتریبیوشن از فیلد `attribution` به شکل `شخصیت · اثر` خوانده می‌شود.
