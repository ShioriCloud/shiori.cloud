...
اسپلش نقل‌قول‌محور است: پس‌زمینهٔ کم‌نور کتابخانه، فقط دیالوگ + اعتبار کوتاه، و یک نوار پیشرفت واقعی با متن ثابت «در حال آماده‌سازی…». لود P0 هوم پشت صحنه می‌ماند؛ حداقل ~۳٫۲s برای خواندن و سقف زمانی برای نت ضعیف.
